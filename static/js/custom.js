...
//   }
//   img.src = "map_names_2colorsbig.svg";
// }
...
function owlCarousel() {
  $("#owl-example,#owl-example2,#owl-example3,#owl-example4,#owl-example5,#owl-example6,#owl-example7,#owl-example8,#owl-example9,#owl-example10,#owl-example11,#owl-example12,#owl-example13")
  .owlCarousel({
    lazyLoad : true,
    items: 3,
